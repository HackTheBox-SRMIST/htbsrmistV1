                ...
                <div className="h-screen flex flex-col md:flex-row items-center justify-center md:gap-14 lg:gap-24">
                    <div className="w-full md:w-1/2">
                        <div className="mb-4 text-center md:text-left">
                            <h1 className="text-white text-3xl pt-56 sm:pt-0 sm:ml-8 pl-10 sm:pl-0  md:mt-10 lg:mt-0 sm:text-5xl  font-semibold ">
                                {event?.event_name}
                            </h1>
                            <p className="text-white ml-8 break-all sm:break-normal  pt-4 sm:text-xl sm:mt-4 pr-8text-center md:text-left text-sm ">
