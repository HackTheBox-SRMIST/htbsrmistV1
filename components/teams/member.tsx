...
const Member = (props: any) => {
    return (
        <div className="text-white flex flex-col items-center py-10 mt-2 transition duration-300 px-2 w-auto rounded-3xl hover:shadow-[0_0_2px_#8bef00,inset_0_0_2px_#8bef00,0_0_5px_#8bef00,0_0_15px_#8bef00,0_0_#8bef00]">
            <img
